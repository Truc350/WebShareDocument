  ...
  <div class="container nav-wrap">
    ...
    <div class="auth-actions" style="display: flex; align-items: center; gap: 12px;">
      ...
      <% if (loggedInUser != null) { %>
        ...
        <a class="btn btn-ghost" href="${pageContext.request.contextPath}/logout" style="color: #dc3545; padding: 0.5rem; display: flex; align-items: center; justify-content: center;" title="Đăng xuất">
