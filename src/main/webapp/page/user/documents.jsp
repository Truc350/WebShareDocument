        ...
        <div class="documents-layout">
            ...
            <section class="documents-content">
                ...
                <div class="documents-grid" id="documentsGrid">
                    ...
                    <article class="doc-card" style="cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/page/user/document-detail.jsp'" data-title="Đề thi Toán cao cấp 1" data-category="Đề thi" data-subject="Toán" data-format="DOCX" data-downloads="890" data-date="2024-04-05">
                    ...
                    <article class="doc-card" style="cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/page/user/document-detail.jsp'" data-title="Bài giảng Trí tuệ Nhân tạo" data-category="Tham khảo" data-subject="CNTT" data-format="PPTX" data-downloads="234" data-date="2024-03-28">
                    ...
                    <article class="doc-card" style="cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/page/user/document-detail.jsp'" data-title="Tài liệu ôn thi Hóa học hữu cơ" data-category="Bài tập" data-subject="Hóa học" data-format="PDF" data-downloads="1120" data-date="2024-03-25">
                    ...
                    <article class="doc-card" style="cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/page/user/document-detail.jsp'" data-title="Bài tập Lập trình C cơ bản" data-category="Bài tập" data-subject="CNTT" data-format="PDF" data-downloads="640" data-date="2024-03-20">
                    ...
                    <article class="doc-card" style="cursor: pointer;" onclick="window.location.href='${pageContext.request.contextPath}/page/user/document-detail.jsp'" data-title="Bảng công thức Excel kế toán" data-category="Tham khảo" data-subject="Kinh tế" data-format="XLSX" data-downloads="312" data-date="2024-03-18">
